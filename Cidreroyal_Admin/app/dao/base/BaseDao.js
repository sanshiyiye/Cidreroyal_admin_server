 ...
 * @param {any} udata 更新字段数据
 * @returns promise
 */
BaseDao.prototype.updateAll = function (query, udata) {
  var params = {
    where: {},
  };
  ...
  return this.model.update(udata, params);
};
 ...
 * @param _order 升序或是降序
 */
BaseDao.prototype.queryListAndCount = function (query, needEntity, _page, _perPage, _sort, _order) {
  var params = {
    where: {},
  };
